...
- Prozess 'lastganganalyse' (v1.1.0, Stand 2026-07-22): Aus einem Lastgang (15-min-Netzbezug/-Verbrauch, per EDA-Consent) verstehen, was den Verbrauch treibt, und beziffern, welcher Hebel — in der Reihenfolge Tarif vor Verhalten vor Speicher — was bringt. (8 Pflicht-Caveat(s), Tool-Mapping gegen den v1-Katalog gelintet.)
