...
def main(argv: list[str] | None = None) -> int:
    ...
    for cap in registry.all():
        # argparse interpretiert help-Strings als printf-%-Format; Prozentzeichen
        # in cap.summary (z. B. "20 % USt") muss escaped werden, sonst crasht
        # bereits der Aufbau der Subparser-Tabelle (ValueError: badly formed help).
        cap_parser = sub.add_parser(cap.name, help=cap.summary.replace("%", "%%"))
