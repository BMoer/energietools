...
> **Netzkosten** und **Abgaben**, ihre regulatorische Grundlage (Systemnutzungsentgelte-Verordnung) und ihr
...
> **2026** (Systemnutzungsentgelte-Verordnung 2018 – Novelle 2026).
>
...
| **2. Netzkosten** | Nutzung & Verluste des Stromnetzes | **bundesweite Entgelt-Verordnung** (BGBl. II Nr. 305/2025), je Netzbereich | Nein — hängt am Wohnort |
...
sind **reguliert** (kein Wettbewerb) und in der **bundesweiten
Systemnutzungsentgelte-Verordnung (BGBl. II Nr. 305/2025)** festgelegt — pro
...
Lastprofilmessung). Das ist die für die Haushalts-Kostenrechnung relevante Zeile. (Größere NE-7-Kunden mit
...
1. **Netznutzungsentgelt** (§ 5 der Systemnutzungsentgelte-Verordnung) — die Nutzung des Netzes:
...
2. **Netzverlustentgelt** (§ 6 der Systemnutzungsentgelte-Verordnung) — deckt die physikalischen Leitungsverluste,
...
### 2.3 Die Systemnutzungsentgelte-Verordnung und die 14 Netzbereiche

Die **Systemnutzungsentgelte-Verordnung 2018** wird jährlich novelliert. Maßgeblich für 2026 ist die **Novelle 2026
...
Die **§ 13-Tabellen** der Systemnutzungsentgelte-Verordnung (Zahler/Empfänger) sind **Ausgleichszahlungen zwischen
...
| Graz / Linz / Klagenfurt / Salzburg / Innsbruck | offen | nicht verifiziert — nicht angesetzt (rate=0) |
| übrige Gemeinden | i. d. R. 0 % | nicht verifiziert — nicht angesetzt (rate=0) |
...
├── Netz      ── Verordnung BGBl. 305/25 ──► fix je Netzbereich (Block 2)
...
8. **Keine fremde Rechner-API als Quelle.** Primärquelle sind die VNB-Preisblätter,
   cross-gecheckt gegen die Verordnung (BGBl. II Nr. 305/2025). Ein Rechner darf
   höchstens prüfen, nie liefern.

---

## 8. Glossar

- **Systemnutzungsentgelte-Verordnung** (BGBl. II Nr. 305/2025) — legt die regulierten
  Netzkosten je Netzbereich fest.
...
- **Bundesweite Systemnutzungsentgelte-Verordnung**, BGBl. II Nr. 305/2025, in Kraft
  01.01.2026 — autoritative Tarifliste aller 14 Netzbereiche (NE-7-Arbeitspreis § 5,
  Netzverlust § 6, Ausgleich § 13).
...
Novelle der Systemnutzungsentgelte-Verordnung bzw. Abgaben-Verordnung neu festgesetzt.*
